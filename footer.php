                    ...
                    <div class="horario small-5 medium-3 small-offset-1 medium-offset-0 columns">
                        ...
                        <?php
                            ...
                            if($dia_semana >= 1 && $dia_semana <= 6) {
                                if($hora_atual < 41400){ //41400 representa 11h30 desde os segundos do inicio do dia (00h)
                                ...
                                if($hora_atual > 7200 && $hora_atual < 41400){ //7200 representa a conversao de 2h da manha a partir do inicio dia dia (00h)  
                                    $texto_horario = '(Fechado Agora)';
                                    $classe_horario = 'horario-fechado';
                                } else if($hora_atual > 64800) {
                                    $texto_horario = '(Fechado Agora)';
                                    $classe_horario = 'horario-fechado';
                                } else {
                                    $texto_horario = '(Aberto Agora)';
